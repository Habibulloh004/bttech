...
const About = () => {
  return (
    <main className="mt-32 lg:mt-44">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 place-items-top gap-5 mt-10 w-10/12 md:w-9/12 mx-auto text-center">
        {companyCards.map((item, idx) => (
          <motion.div
            key={item.id}
